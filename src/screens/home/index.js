    ...
    render() {
        return (
            <View style={{ flex: 1, backgroundColor: variables.COLOR.white }}>
                ...
                <ScrollView>
                    <BannerSlide />
                    <View style={{ paddingHorizontal: variables.PadNomarl, backgroundColor: variables.backgroundColor, flex: 1 }}>
                        <View style={{ flexDirection: 'row', marginTop: 10 }}>
                            <View style={{ width: 5, height: 20, backgroundColor: variables.mainColor }} />
